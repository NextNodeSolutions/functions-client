 ...
 */
export const DEFAULT_QUALITY: ImageQualityConfig = {
	png: 100,
	webp: 90,
	avif: 85,
	jpeg: 80,
 ...
 */
export const LOSSLESS_QUALITY: ImageQualityConfig = {
	png: 100,
	webp: 100,
	avif: 100,
	jpeg: 95,
 ...
 */
export const AGGRESSIVE_QUALITY: ImageQualityConfig = {
	png: 85,
	webp: 75,
	avif: 70,
	jpeg: 65,
 ...
 */
export function shouldUseMozjpeg(format: ImageFormat): boolean {
 ...
 */
export function shouldUsePngquant(format: ImageFormat): boolean {
	return format === 'png'
}
